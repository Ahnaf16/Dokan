...
//update user data
  ...
  //update user name
  updateAuthNameAndImgURL() {
    return _currentUser!.updateDisplayName(_nameController!.text).then(
  ...
  //image picker, crop and upload to firebase storage
  Future selectImg(ImageSource imgSource) async {
    try {
      ...
      _currentUser!.updatePhotoURL(_pickedImgStorage!);
                ...
                children: [
                  Visibility(
                    ...
                    child: LinearProgressIndicator(
                      valueColor:
                          AlwaysStoppedAnimation<Color>(AppColor.appMainColor),
                      backgroundColor: AppColor.appSecColor,
                    ),
                  ),
                  cDivider(5),
